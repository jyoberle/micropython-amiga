...
extern void mp_hal_stdio_mode_orig(void);
extern void mp_hal_stdio_mode_raw(void);
...
int main(int argc, char **argv) {
    ...
    struct WBStartup *wbmsg = NULL; // starting from Workbench is not supported
